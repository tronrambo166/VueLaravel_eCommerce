    ...
    <div class="col-sm-8"> 
            ...
            <div class="navbar navbar-expand-sm bg-light p-0 w-100 navy text-center">
                <ul class="navbar-nav m-auto">
                    ...
                    <li class="nav-item py-1 px-3 bg-light border-right"><a href="{{ route('products') }}" class="text-dark nav-link">PRODUCTS</a></li>

                    <li class="nav-item py-1 px-3 bg-light border-right"><a href="{{ route('brands') }}" class="text-dark nav-link">TOP BRANDS</a></li>

                    <li class="nav-item py-1 px-3 bg-light border-right"><a href="{{ route('cart') }}" class="text-dark nav-link">CART</a></li>
